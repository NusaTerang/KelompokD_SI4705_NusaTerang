...
<body class="min-h-screen bg-slate-50 font-sans text-slate-800 antialiased">
    ...
    <header class="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur">
        <div class="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-4 py-3 sm:px-6">
            ...
            <a href="{{ url('/') }}" class="text-xl font-bold text-nt-navy">
                NusaTerang
            </a>
            ...
            <div class="flex items-center gap-3">
                ...
                @auth
                    ...
                    <a
                        ...
                        class="text-sm font-semibold {{ request()->routeIs('profil.*') ? 'border-b-2 border-nt-accent text-nt-navy' : 'text-slate-600 hover:text-nt-navy' }}">
                    ...
                    <form action="{{ route('logout') }}" method="POST" class="inline">
                        ...
                        <button
                            type="submit"
                            class="text-sm text-slate-500 hover:text-nt-navy">
                ...
                @else
                    ...
                    <a
                        href="{{ route('login') }}"
                        class="rounded-xl bg-nt-accent px-4 py-2 text-sm font-bold text-nt-navy hover:bg-nt-accent-hover">
    ...
    <footer class="mt-16 border-t border-slate-200 bg-white py-10">
        <div class="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-4 sm:flex-row sm:px-6">
            ...
            <span class="text-lg font-bold text-nt-navy/70">
                NusaTerang
            </span>
            ...
            <p class="text-center text-xs text-slate-400 sm:text-right">
                © {{ date('Y') }} NusaTerang. Membangun masa depan bertenaga surya.
            </p>
