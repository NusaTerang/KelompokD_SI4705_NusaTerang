...
@section('content')
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <form action="{{ route('profil.update') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" value="Jakarta Selatan, Indonesia"
                                class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm">
                        </div>

                        <button type="submit" class="w-full rounded-xl bg-nt-accent py-3 font-semibold text-nt-navy">
                            Simpan Perubahan
                        </button>
    ...
    <div class="mx-auto max-w-[1200px] px-4 pb-8">
