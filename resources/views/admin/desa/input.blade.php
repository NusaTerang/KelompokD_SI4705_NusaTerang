                ...
                <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:items-end">
                            ...
                            <button type="button" class="inline-flex shrink-0 items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-nt-navy shadow-sm hover:bg-slate-50">
